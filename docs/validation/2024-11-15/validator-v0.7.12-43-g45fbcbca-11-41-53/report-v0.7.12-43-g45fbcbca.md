# v0.7.12-43-g45fbcbca

## Build Info

   - `kepler_exporter_build_info{arch="amd64", branch="main", instance="localhost:8888", job="metal", os="linux", revision="15ddff2a6dfb9368a60d9bbb9e8e8f736d354a98", version="v0.7.12-41-g15ddff2a"}`
   - `kepler_exporter_build_info{arch="amd64", branch="main", instance="localhost:9999", job="vm", os="linux", revision="15ddff2a6dfb9368a60d9bbb9e8e8f736d354a98", version="v0.7.12-41-g15ddff2a"}`
## Node Info
...
## Validation Results
   ...
   - Started At: `2024-11-15 11:21:27.446456`
   - Ended   At: `2024-11-15 11:41:38.123254`
   - Duration  : `0:20:10.676798`
## Validations
...
| --- | --- | --- | --- | --- |
| [node-rapl - kepler-package](#node-rapl---kepler-package) | 1.84 | 2.08 | 0.98 | PASS |
| [platform - absolute](#platform---absolute) | 16882364466631.11 | 100.00 | 4072265.60 | PASS |
| [package - absolute](#package---absolute) | 11363.74 | 413.00 | 105.86 | PASS |
| [core - absolute](#core---absolute) | 11610.45 | 432.36 | 107.03 | PASS |
| [platform - dynamic](#platform---dynamic) | 16882364466631.11 | 100.00 | 4072265.60 | PASS |
| [package - dynamic](#package---dynamic) | 11363.74 | 413.00 | 105.86 | PASS |
| [core - dynamic](#core---dynamic) | 11610.45 | 432.36 | 107.03 | PASS |
| [dram - dynamic](#dram---dynamic) | 302.83 | 1298.15 | 17.40 | PASS |
| [cpu-time - absolute](#cpu-time---absolute) | 1606315.08 | 13.86 | 779.97 | PASS |
