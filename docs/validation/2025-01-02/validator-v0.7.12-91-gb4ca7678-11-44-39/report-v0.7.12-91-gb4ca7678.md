# v0.7.12-91-gb4ca7678

## Build Info

   - `kepler_exporter_build_info{arch="amd64", branch="main", instance="localhost:8888", job="metal", os="linux", revision="b4ca7678a9361abf8eb5b9cb3fd9a448ba8a545c", version="v0.7.12-91-gb4ca7678"}`
   - `kepler_exporter_build_info{arch="amd64", branch="main", instance="localhost:9999", job="vm", os="linux", revision="b4ca7678a9361abf8eb5b9cb3fd9a448ba8a545c", version="v0.7.12-91-gb4ca7678"}`
## Node Info
...
## Validation Results
   ...
   - Started At: `2025-01-02 11:24:15.575819`
   - Ended   At: `2025-01-02 11:44:24.987942`
   - Duration  : `0:20:09.412123`
## Validations
...
| --- | --- | --- | --- | --- |
| [node-rapl - kepler-package](#node-rapl---kepler-package) | 1.21 | 1.99 | 0.82 | PASS |
| [platform - absolute](#platform---absolute) | 16834636329213.18 | 100.00 | 4062341.86 | PASS |
| [package - absolute](#package---absolute) | 11509.60 | 397.43 | 106.23 | PASS |
| [core - absolute](#core---absolute) | 11756.36 | 420.94 | 107.40 | PASS |
| [platform - dynamic](#platform---dynamic) | 16834636329213.18 | 100.00 | 4062341.86 | PASS |
| [package - dynamic](#package---dynamic) | 11509.60 | 397.43 | 106.23 | PASS |
| [core - dynamic](#core---dynamic) | 11756.36 | 420.94 | 107.40 | PASS |
| [dram - dynamic](#dram---dynamic) | 302.90 | 1141.10 | 17.40 | PASS |
| [cpu-time - absolute](#cpu-time---absolute) | 1128041.96 | 15.15 | 741.56 | PASS |
