# v0.7.12-85-g20979b2b

## Build Info

   - `kepler_exporter_build_info{arch="amd64", branch="main", instance="localhost:8888", job="metal", os="linux", revision="c9524a831617f13e9b820dde1c22fc92c517b9d1", version="v0.7.12-80-gc9524a83"}`
   - `kepler_exporter_build_info{arch="amd64", branch="main", instance="localhost:9999", job="vm", os="linux", revision="c9524a831617f13e9b820dde1c22fc92c517b9d1", version="v0.7.12-80-gc9524a83"}`
## Node Info
...
## Validation Results
   ...
   - Started At: `2024-12-11 11:23:36.178945`
   - Ended   At: `2024-12-11 11:43:45.643685`
   - Duration  : `0:20:09.464740`
## Validations
...
| --- | --- | --- | --- | --- |
| [node-rapl - kepler-package](#node-rapl---kepler-package) | 0.23 | 0.86 | 0.40 | PASS |
| [platform - absolute](#platform---absolute) | 16869976167750.46 | 100.00 | 4069247.61 | PASS |
| [package - absolute](#package---absolute) | 11463.08 | 395.14 | 106.04 | PASS |
| [core - absolute](#core---absolute) | 11710.74 | 417.87 | 107.21 | PASS |
| [platform - dynamic](#platform---dynamic) | 16869976167750.46 | 100.00 | 4069247.61 | PASS |
| [package - dynamic](#package---dynamic) | 11463.08 | 395.14 | 106.04 | PASS |
| [core - dynamic](#core---dynamic) | 11710.74 | 417.87 | 107.21 | PASS |
| [dram - dynamic](#dram---dynamic) | 302.64 | 1146.17 | 17.39 | PASS |
| [cpu-time - absolute](#cpu-time---absolute) | 969015.33 | 13.24 | 665.44 | PASS |
