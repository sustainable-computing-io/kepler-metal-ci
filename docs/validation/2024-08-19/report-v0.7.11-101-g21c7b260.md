# v0.7.11-101-g21c7b260

## Build Info

   - `kepler_exporter_build_info{arch="amd64", branch="main", instance="localhost:8888", job="metal", os="linux", revision="21c7b260903a0ed169a46da64db806ddfa982ba0", version="v0.7.11-101-g21c7b260"}`
   - `kepler_exporter_build_info{arch="amd64", branch="main", instance="localhost:9999", job="vm", os="linux", revision="21c7b260903a0ed169a46da64db806ddfa982ba0", version="v0.7.11-101-g21c7b260"}`
## Node Info
...
## Validation Results
   ...
   - Started At: `2024-08-19 15:14:00.699478`
   - Ended   At: `2024-08-19 15:30:44.773502`
   - Duration  : `0:16:44.074024`
## Validations
...
| --- | --- | --- | --- |
| platform - dynamic | 900.09 | 54.80 | PASS |
| package - dynamic | 783.18 | 59.28 | PASS |
| core - dynamic | 781.77 | 59.27 | PASS |
| dram - dynamic | 24.31 | inf | PASS |
| platform - idle | 48374.63 | 22863.18 | PASS |
| package - idle | 4871.69 | 58587.06 | PASS |
| core - idle | 4874.22 | 69055.12 | PASS |
| dram - idle | 2220.20 | 204999.71 | PASS |
### Details
