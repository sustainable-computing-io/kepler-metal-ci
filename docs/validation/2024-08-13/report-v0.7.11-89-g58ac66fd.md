# v0.7.11-89-g58ac66fd

## Build Info

   - `kepler_exporter_build_info{arch="amd64", branch="main", instance="localhost:8888", job="metal", os="linux", revision="58ac66fd1200f6305246c18339bebffe7daa1d6d", version="v0.7.11-89-g58ac66fd"}`
   - `kepler_exporter_build_info{arch="amd64", branch="main", instance="localhost:9999", job="vm", os="linux", revision="58ac66fd1200f6305246c18339bebffe7daa1d6d", version="v0.7.11-89-g58ac66fd"}`
## Node Info
...
## Validation Results
   ...
   - Started At: `2024-08-13 12:17:35.566179`
   - Ended   At: `2024-08-13 12:20:56.265263`
   - Duration  : `0:03:20.699084`
## Validations
...
| --- | --- | --- | --- |
| platform - dynamic | 1608.38 | inf | PASS |
| package - dynamic | 229.15 | inf | PASS |
| core - dynamic | 229.37 | inf | PASS |
| dram - dynamic | 24.37 | inf | PASS |
| platform - idle | 2422404455.46 | 99.50 | PASS |
| package - idle | 4876.22 | 85858.20 | PASS |
| core - idle | 4878.40 | 104769.76 | PASS |
| dram - idle | 2219.55 | 168481.48 | PASS |
### Details
