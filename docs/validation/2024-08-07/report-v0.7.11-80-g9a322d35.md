# v0.7.11-80-g9a322d35

## Build Info

   - `kepler_exporter_build_info{arch="amd64", branch="main", instance="localhost:8888", job="metal", os="linux", revision="39ef719558ea8fae9fe0ee274157f6a7b9e01367", version="v0.7.11-75-g39ef7195"}`
   - `kepler_exporter_build_info{arch="amd64", branch="main", instance="localhost:9999", job="vm", os="linux", revision="39ef719558ea8fae9fe0ee274157f6a7b9e01367", version="v0.7.11-75-g39ef7195"}`
## Machine Specs
...
## Validation Results
   ...
   - Started At: `2024-08-07 20:10:47.761042`
   - Ended   At: `2024-08-07 20:14:08.578899`
   - Duration  : `0:03:20.817857`
## Validations
...
| --- | --- | --- | --- |
| platform - dynamic | 5673.29 | inf | PASS |
| package - dynamic | 1483.48 | 10825.68 | PASS |
| core - dynamic | 1482.07 | 10768.51 | PASS |
| dram - dynamic | 85.95 | inf | PASS |
| platform - idle | 5532527723.02 | 99.70 | PASS |
| package - idle | 4840.90 | 20441.66 | PASS |
| core - idle | 4844.20 | 21981.34 | PASS |
| dram - idle | 2218.62 | 118968.36 | PASS |
### Details
