# v0.7.11-82-gdd3e88b8

## Build Info

   - `kepler_exporter_build_info{arch="amd64", branch="main", instance="localhost:8888", job="metal", os="linux", revision="dd3e88b898836aaf9ac34ab243e5cf34bca70af1", version="v0.7.11-82-gdd3e88b8"}`
   - `kepler_exporter_build_info{arch="amd64", branch="main", instance="localhost:9999", job="vm", os="linux", revision="dd3e88b898836aaf9ac34ab243e5cf34bca70af1", version="v0.7.11-82-gdd3e88b8"}`
## Node Info
...
## Validation Results
   ...
   - Started At: `2024-08-07 22:40:28.828685`
   - Ended   At: `2024-08-07 22:43:49.578308`
   - Duration  : `0:03:20.749623`
## Validations
...
| --- | --- | --- | --- |
| platform - dynamic | 2104.95 | inf | PASS |
| package - dynamic | 290.62 | inf | PASS |
| core - dynamic | 291.70 | inf | PASS |
| dram - dynamic | 31.90 | inf | PASS |
| platform - idle | 1726646130.65 | 99.44 | PASS |
| package - idle | 4878.02 | 97442.28 | PASS |
| core - idle | 4879.85 | 118219.90 | PASS |
| dram - idle | 2219.97 | 190640.39 | PASS |
### Details
