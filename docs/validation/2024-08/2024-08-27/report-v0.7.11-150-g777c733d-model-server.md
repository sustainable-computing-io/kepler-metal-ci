# v0.7.11-150-g777c733d

## Build Info

   - `kepler_exporter_build_info{arch="amd64", branch="main", instance="localhost:8888", job="metal", os="linux", revision="777c733dfc4a696c17d06494fa7d783e4b3af6e5", version="v0.7.11-150-g777c733d-dirty"}`
   - `kepler_exporter_build_info{arch="amd64", branch="main", instance="localhost:9999", job="vm", os="linux", revision="777c733dfc4a696c17d06494fa7d783e4b3af6e5", version="v0.7.11-150-g777c733d-dirty"}`
## Node Info
...
## Validation Results
   ...
   - Started At: `2024-08-27 19:16:15.669069`
   - Ended   At: `2024-08-27 19:32:59.637114`
   - Duration  : `0:16:43.968045`
## Validations
...
| --- | --- | --- | --- |
| platform - dynamic | 3718.14 | 118.63 | PASS |
| package - dynamic | 876.68 | 58.46 | PASS |
| core - dynamic | 875.83 | 58.46 | PASS |
| dram - dynamic | 0.55 | inf | PASS |
| platform - idle | 3964.22 | 5581.81 | PASS |
| package - idle | 20639.50 | 97770.65 | PASS |
| core - idle | 20645.15 | 112816.70 | PASS |
| dram - idle | 345.62 | 73904.13 | PASS |
### Details
