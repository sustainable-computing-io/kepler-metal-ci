# v0.7.11-126-gc106b466

## Build Info

   - `kepler_exporter_build_info{arch="amd64", branch="main", instance="localhost:8888", job="metal", os="linux", revision="c106b466685f9bbf00af201759fef7d1c2b11e9d", version="v0.7.11-126-gc106b466-dirty"}`
   - `kepler_exporter_build_info{arch="amd64", branch="main", instance="localhost:9999", job="vm", os="linux", revision="c106b466685f9bbf00af201759fef7d1c2b11e9d", version="v0.7.11-126-gc106b466-dirty"}`
## Node Info
...
## Validation Results
   ...
   - Started At: `2024-08-22 12:15:12.529848`
   - Ended   At: `2024-08-22 12:31:56.839961`
   - Duration  : `0:16:44.310113`
## Validations
...
| --- | --- | --- | --- |
| platform - dynamic | 748.29 | 95.23 | PASS |
| package - dynamic | 672.49 | 167.06 | PASS |
| core - dynamic | 669.60 | 164.96 | PASS |
| dram - dynamic | 24.38 | 63164.60 | PASS |
| platform - idle | 48262.52 | 18292.03 | PASS |
| package - idle | 4860.11 | 38890.31 | PASS |
| core - idle | 4863.14 | 44717.79 | PASS |
| dram - idle | 2216.24 | 72521.90 | PASS |
### Details
