# v0.7.11-122-gcefe652e

## Build Info

   - `kepler_exporter_build_info{arch="amd64", branch="main", instance="localhost:8888", job="metal", os="linux", revision="cefe652e3777b02f12390c5b8b16249dfce209b9", version="v0.7.11-122-gcefe652e-dirty"}`
   - `kepler_exporter_build_info{arch="amd64", branch="main", instance="localhost:9999", job="vm", os="linux", revision="cefe652e3777b02f12390c5b8b16249dfce209b9", version="v0.7.11-122-gcefe652e-dirty"}`
## Node Info
...
## Validation Results
   ...
   - Started At: `2024-08-21 12:16:22.443717`
   - Ended   At: `2024-08-21 12:33:06.654753`
   - Duration  : `0:16:44.211036`
## Validations
...
| --- | --- | --- | --- |
| platform - dynamic | 884.49 | 71.65 | PASS |
| package - dynamic | 775.00 | 141.53 | PASS |
| core - dynamic | 773.68 | 137.27 | PASS |
| dram - dynamic | 23.98 | inf | PASS |
| platform - idle | 48285.68 | 18883.61 | PASS |
| package - idle | 4867.49 | 47732.98 | PASS |
| core - idle | 4870.50 | 56096.81 | PASS |
| dram - idle | 2219.76 | 170853.18 | PASS |
### Details
