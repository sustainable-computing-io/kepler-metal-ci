# v0.7.11-97-gc9d84677

## Build Info

   - `kepler_exporter_build_info{arch="amd64", branch="main", instance="localhost:8888", job="metal", os="linux", revision="c9d84677916eb3606404977659c87616bde1249d", version="v0.7.11-97-gc9d84677"}`
   - `kepler_exporter_build_info{arch="amd64", branch="main", instance="localhost:9999", job="vm", os="linux", revision="c9d84677916eb3606404977659c87616bde1249d", version="v0.7.11-97-gc9d84677"}`
## Node Info
...
## Validation Results
   ...
   - Started At: `2024-08-16 12:18:30.578358`
   - Ended   At: `2024-08-16 12:21:51.752977`
   - Duration  : `0:03:21.174619`
## Validations
...
| --- | --- | --- | --- |
| platform - dynamic | 1640.06 | inf | PASS |
| package - dynamic | 647.09 | 112.83 | PASS |
| core - dynamic | 652.89 | 112.49 | PASS |
| dram - dynamic | 23.01 | 2700.59 | PASS |
| platform - idle | 6779221878.77 | 99.73 | PASS |
| package - idle | 4866.09 | 43711.16 | PASS |
| core - idle | 4869.81 | 52524.62 | PASS |
| dram - idle | 2219.06 | 133779.65 | PASS |
### Details
