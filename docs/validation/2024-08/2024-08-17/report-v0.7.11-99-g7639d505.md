# v0.7.11-99-g7639d505

## Build Info

   - `kepler_exporter_build_info{arch="amd64", branch="main", instance="localhost:8888", job="metal", os="linux", revision="7639d5054021402c7780d1e7d542f3e1251529c0", version="v0.7.11-99-g7639d505"}`
   - `kepler_exporter_build_info{arch="amd64", branch="main", instance="localhost:9999", job="vm", os="linux", revision="7639d5054021402c7780d1e7d542f3e1251529c0", version="v0.7.11-99-g7639d505"}`
## Node Info
...
## Validation Results
   ...
   - Started At: `2024-08-17 12:15:20.122829`
   - Ended   At: `2024-08-17 12:18:41.151770`
   - Duration  : `0:03:21.028941`
## Validations
...
| --- | --- | --- | --- |
| platform - dynamic | 864.39 | 121.33 | PASS |
| package - dynamic | 710.92 | 132.81 | PASS |
| core - dynamic | 707.83 | 132.98 | PASS |
| dram - dynamic | 25.38 | inf | PASS |
| platform - idle | 48365.16 | 22392.43 | PASS |
| package - idle | 4868.32 | 48667.43 | PASS |
| core - idle | 4871.01 | 56252.57 | PASS |
| dram - idle | 2216.84 | 80777.93 | PASS |
### Details
