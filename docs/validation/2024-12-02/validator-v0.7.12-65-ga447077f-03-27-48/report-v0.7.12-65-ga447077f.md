# v0.7.12-65-ga447077f

## Build Info

   - `kepler_exporter_build_info{arch="amd64", branch="main", instance="localhost:8888", job="metal", os="linux", revision="a447077ffd2e40f633f2aa200b1b8d61063573c4", version="v0.7.12-65-ga447077f"}`
   - `kepler_exporter_build_info{arch="amd64", branch="main", instance="localhost:9999", job="vm", os="linux", revision="a447077ffd2e40f633f2aa200b1b8d61063573c4", version="v0.7.12-65-ga447077f"}`
## Node Info
...
## Validation Results
   ...
   - Started At: `2024-12-02 03:07:24.000759`
   - Ended   At: `2024-12-02 03:27:33.276517`
   - Duration  : `0:20:09.275758`
## Validations
...
| --- | --- | --- | --- | --- |
| [node-rapl - kepler-package](#node-rapl---kepler-package) | 4.01 | 3.75 | 1.63 | PASS |
| [platform - absolute](#platform---absolute) | 16853590867002.56 | 100.00 | 4065386.68 | PASS |
| [package - absolute](#package---absolute) | 11362.45 | 392.75 | 105.58 | PASS |
| [core - absolute](#core---absolute) | 11608.55 | 415.38 | 106.75 | PASS |
| [platform - dynamic](#platform---dynamic) | 16853590867002.56 | 100.00 | 4065386.68 | PASS |
| [package - dynamic](#package---dynamic) | 11362.45 | 392.75 | 105.58 | PASS |
| [core - dynamic](#core---dynamic) | 11608.55 | 415.38 | 106.75 | PASS |
| [dram - dynamic](#dram---dynamic) | 302.29 | 1151.96 | 17.38 | PASS |
| [cpu-time - absolute](#cpu-time---absolute) | 928394.47 | 10.83 | 597.76 | PASS |
