# v0.7.12-120-gbd0d8cbf

## Build Info

   - `kepler_exporter_build_info{arch="amd64", branch="main", instance="localhost:8888", job="metal", os="linux", revision="bd0d8cbf1eb4a5fdd8a2adda86448c59daf889d3", version="v0.7.12-120-gbd0d8cbf"}`
   - `kepler_exporter_build_info{arch="amd64", branch="main", instance="localhost:9999", job="vm", os="linux", revision="bd0d8cbf1eb4a5fdd8a2adda86448c59daf889d3", version="v0.7.12-120-gbd0d8cbf"}`
## Node Info
...
## Validation Results
   ...
   - Started At: `2025-03-10 12:25:22.355057`
   - Ended   At: `2025-03-10 12:45:31.558247`
   - Duration  : `0:20:09.203190`
## Validations
...
| --- | --- | --- | --- | --- |
| [node-rapl - kepler-package](#node-rapl---kepler-package) | 6.65 | 4.67 | 2.02 | PASS |
| [platform - absolute](#platform---absolute) | 16770782563841.41 | 100.00 | 4054080.30 | PASS |
| [package - absolute](#package---absolute) | 11739.75 | 374.65 | 107.35 | PASS |
| [core - absolute](#core---absolute) | 11945.55 | 394.08 | 108.31 | PASS |
| [platform - dynamic](#platform---dynamic) | 16770782563841.41 | 100.00 | 4054080.30 | PASS |
| [package - dynamic](#package---dynamic) | 11739.75 | 374.65 | 107.35 | PASS |
| [core - dynamic](#core---dynamic) | 11945.55 | 394.08 | 108.31 | PASS |
| [dram - dynamic](#dram---dynamic) | 303.33 | 1127.50 | 17.41 | PASS |
| [cpu-time - absolute](#cpu-time---absolute) | 1158957.48 | 12.82 | 706.80 | PASS |
