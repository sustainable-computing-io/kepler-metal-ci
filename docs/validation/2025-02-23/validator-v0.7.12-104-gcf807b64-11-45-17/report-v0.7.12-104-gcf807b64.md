# v0.7.12-104-gcf807b64

## Build Info

   - `kepler_exporter_build_info{arch="amd64", branch="main", instance="localhost:8888", job="metal", os="linux", revision="cf807b640538b2a3bf72db162abc371a8ec9901c", version="v0.7.12-104-gcf807b64"}`
   - `kepler_exporter_build_info{arch="amd64", branch="main", instance="localhost:9999", job="vm", os="linux", revision="cf807b640538b2a3bf72db162abc371a8ec9901c", version="v0.7.12-104-gcf807b64"}`
## Node Info
...
## Validation Results
   ...
   - Started At: `2025-02-23 11:24:53.067589`
   - Ended   At: `2025-02-23 11:45:02.497966`
   - Duration  : `0:20:09.430377`
## Validations
...
| --- | --- | --- | --- | --- |
| [node-rapl - kepler-package](#node-rapl---kepler-package) | 12.13 | 6.12 | 2.88 | PASS |
| [platform - absolute](#platform---absolute) | 16807929104868.33 | 100.00 | 4060550.73 | PASS |
| [package - absolute](#package---absolute) | 11417.94 | 402.52 | 105.79 | PASS |
| [core - absolute](#core---absolute) | 11664.21 | 424.96 | 106.96 | PASS |
| [platform - dynamic](#platform---dynamic) | 16807929104868.33 | 100.00 | 4060550.73 | PASS |
| [package - dynamic](#package---dynamic) | 11417.94 | 402.52 | 105.79 | PASS |
| [core - dynamic](#core---dynamic) | 11664.21 | 424.96 | 106.96 | PASS |
| [dram - dynamic](#dram---dynamic) | 302.76 | 1170.59 | 17.39 | PASS |
| [cpu-time - absolute](#cpu-time---absolute) | 1033903.17 | 13.37 | 687.63 | PASS |
