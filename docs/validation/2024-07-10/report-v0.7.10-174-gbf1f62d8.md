# v0.7.10-174-gbf1f62d8

## Build Info

  * `kepler_exporter_build_info{arch="amd64", branch="main", instance="localhost:8888", job="node", os="linux", revision="bf1f62d8c580aa742d4ae90dedaff70044be9b78", version="v0.7.10-174-gbf1f62d8"}`
  * `kepler_exporter_build_info{arch="amd64", branch="main", instance="localhost:9999", job="vm", os="linux", revision="bf1f62d8c580aa742d4ae90dedaff70044be9b78", version="v0.7.10-174-gbf1f62d8"}`
## Specs
### Host CPU Specs
...
## Validation Results
   ...
   * Started At: `2024-07-10 12:19:28.387141`
   * Ended   At: `2024-07-10 12:22:49.344939`
   * Duration  : `0:03:20.957798`
